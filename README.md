...
```sh
make all        # 构建 kelpie/flock/Stockman（Stockman 依赖见 docs/stockman_macos_setup.md）
...
- `docs/experiment_report.md`（中文实验报告，含场景/指标/结果/威胁）
- `docs/stockman_macos_setup.md`（Stockman 的 macOS/Homebrew 依赖与版本固定说明）
...
- `docs/shepherd_paper.md`：开题报告（研究目标、技术路线、模型与计划）
- `docs/midterm_report.md`：中期答辩/中期检查报告（阶段成果、实验结果、下一步计划）
- `docs/experiment_report.md`：实验报告（复现步骤、场景、数据、图表与分析）
